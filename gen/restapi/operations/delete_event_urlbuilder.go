...
func (o *DeleteEventURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on DeleteEventURL")
	}
...
func (o *DeleteEventURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteEventURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteEventURL")
	}
